...
class Register(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            "title": self.title,
            **({"cloud_image": self.cloud_image} if self.cloud_image else {}),
            **({"cloud_number": self.cloud_number} if self.cloud_number else {}),
            **({"cloud_duration": self.cloud_duration} if self.cloud_duration else {}),
